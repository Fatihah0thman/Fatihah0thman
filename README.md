...
Bachelor of Computer Science (Data Engineering) - Year 1

**Kolej Matrikulasi Johor**  
- CGPA: 3.92  
- MUET: Band 3.5  

**Sekolah Menengah Kebangsaan Bandar Putra**  
- SPM : 2A+,2A-,3B,2C+
...
### 📜 Certificates
- Matriculation Programme Certificate
...
- Developed an AI-based gesture analysis system to help athletes improve their training methods
- Analyzed the accuracy of athlete's movements and body posture during training
  
**Digital Logic Project**
- Develop secure elevator control system using Digital Electronic Deeds Simulator
- The design integrates combinational and sequential logic
